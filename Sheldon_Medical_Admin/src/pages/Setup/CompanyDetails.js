    ...
    getDetail(_id)
      .then((res) => {
        ...
        setValues({
          ...
          Pincode1: res.Pincode1,
          Address2: res.Address2,
          Pincode2: res.Pincode2,
          FAX1:res.FAX1,
          FAX2:res.FAX2,
          MOBILE:res.MOBILE,
          PHONE:res.PHONE,
  ...
  const FaviconUploadAndResize = (e) => {
    ...
    if (files) {
      for (let i = 0; i < files.length; i++) {
        ...
        console.log("formrmrmr",formdata);
        ...
        //     setLoading(true);
        //     axios
        //       .post(process.env.REACT_APP_API_URL_SHELDON + "/api/uploadimages", {
        //         image: uri,
        //       })
        //       .then((res) => {
                          ...
                          {values.Favicon && (
                            <div className="card col-3">
                              <img
                                ...
                                alt="fav-icon"
                                src={
                                  process.env.REACT_APP_API_URL_SHELDON +
                                  "/" +
                                  values.Favicon
                                }
                                onError={(e) => {
