...
export const createCountry = async (values) => {
  return await axios.post(
    `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/location/country`,
    values,
    {
      headers: {
...
export const removeCountry = async (_id) => {
  return await axios.delete(
    `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/location/country/${_id}`
  );
};
...
export const updateCountry = async (_id, values) => {
  return await axios.put(
    `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/location/countryupdate/${_id}`,
    values
  );
};
...
export const createState = async (values) => {
  return await axios.post(
    `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/location/state`,
    values
  );
};
...
export const removeState = async (_id) => {
  return await axios.delete(
    `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/location/state/${_id}`
  );
};
...
export const updateState = async (_id, values) => {
  return await axios.put(
    `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/location/stateupdate/${_id}`,
    values
  );
};
...
export const createCity = async (values) => {
  return await axios.post(
    `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/location/city`,
    values
  );
};
...
export const removeCity = async (_id) => {
  return await axios.delete(
    `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/location/city/${_id}`
  );
};
