...
export const getCmsContactUsDetailById = async (_id) => {
  try {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL_SHELDON}/api/cms/get/contactusdetail/${_id}`
    );
    return response;
  } catch (error) {
...
export const getCmsAboutUsById = async (_id) => {
  try {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL_SHELDON}/api/cms/get/aboutus/${_id}`
    );
    return response;
  } catch (error) {
...
export const editCmsContactUsDetailContent = async (values) => {
  try {
    ...
    const response = await axios.put(
      `${process.env.REACT_APP_API_URL_SHELDON}/api/cms/edit/contactusdetail/${_id}`,
      values
    );
    return response;
  } catch (error) {
...
export const editCmsAboutUsContent = async (values) => {
  try {
    const { _id } = values;
    const response = await axios.put(
      `${process.env.REACT_APP_API_URL_SHELDON}/api/cms/edit/aboutus/${_id}`,
      values
    );
    return response;
  } catch (error) {
...
export const uploadproductImageAboutUs = async (body) => {
    return await axios.post(
      `${process.env.REACT_APP_API_URL_SHELDON}/api/auth/ckeditorAboutUs/imageupload`,
      body
    );
  };